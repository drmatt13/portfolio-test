export default [
  ...
  },
  {
    ...
    description: `I'm certified as an AWS Solutions Architect Professional, Solutions Architect Associate, Developer Associate, and SysOps Administrator Associate, showcasing my expertise in cloud architecture, security, automation, and infrastructure management. I can design highly available, fault-tolerant, and cost-optimized architectures that leverage scalability, redundancy, and performance best practices. My skills include advanced networking with VPC design, subnets, route tables, security groups, NACLs, VPNs, Transit Gateway, and AWS PrivateLink, which ensures secure and efficient cloud connectivity. I understand IAM policies, permission boundaries, SSO, and multi-account governance with AWS Organizations, enabling robust access control and security enforcement.
...
I have experience working with Amazon RDS, designing multi-region failover strategies, cross-region replication, and high-availability configurations to ensure fault tolerance and disaster recovery. Additionally, I can work with MongoDB and DynamoDB, understanding when to choose relational vs. NoSQL solutions based on data access patterns, scalability requirements, and consistency models. Whether designing OLTP or OLAP systems, optimizing complex queries, or tuning database performance, I can ensure efficient, resilient, and well-architected data solutions for a variety of workloads.
...

  {
    ...
    description: `I'm comfortable working across containerized environments and creating Dockerfiles to define application deployments. I’m fully competent with Docker networking, including bridge networks, which enables seamless container communication using service names. I can configure Docker Compose to manage multi-container applications and utilize Docker volumes to persist data across container restarts.
...
`,
  ...
  },
  {
    ...
    image: "tailwind.jpg",
    description: `
      I am proficient in Tailwind CSS, leveraging its utility-first approach to build scalable, maintainable, and highly responsive front-end designs. By utilizing atomic class utilities, I can efficiently style components without writing custom CSS, reducing stylesheet bloat and improving performance. I understand responsive design principles, leveraging flexbox, grid, and spacing utilities to create fluid and adaptive layouts that work seamlessly across all screen sizes.
...
I design with scalability and responsiveness in mind, utilizing flexible grid systems, fluid typography, and adaptive spacing to create layouts that remain consistent and dynamic under various resolutions and orientations. I also pay close attention to layout shifts, interaction patterns, and performance optimizations, ensuring a smooth, interruption-free user experience. Whether it’s crafting design systems, refining micro-interactions, or implementing accessible UI components, I can create modern, engaging, and highly responsive interfaces that enhance usability without compromising performance.`,
  ...
  },
  {
    ...
    image: "auth.png",
    description: `I have a deep understanding of authentication, authorization, and security, with expertise in designing and implementing secure identity management systems from scratch. I can build custom authentication flows, including JWT-based authentication, session management, and password hashing with salting and key stretching algorithms (e.g., bcrypt, Argon2, PBKDF2) to ensure data integrity and resistance to brute-force attacks.

I am proficient in integrating third-party identity providers using OAuth 2.0, OpenID Connect, and SAML assertions, enabling seamless authentication through Microsoft Active Directory, Okta, Auth0, and custom enterprise solutions. I can work with managed authentication services like AWS Cognito, implementing multi-factor authentication (MFA), user pools, and federated identity providers for secure and scalable access control.
...
I am highly proficient in encryption strategies, including symmetric (AES) and asymmetric (RSA, ECC) encryption, secure key exchange protocols, and TLS handshake processes. I understand how TLS certificates, PKI, HMAC, and digital signatures contribute to data security, ensuring secure communication over untrusted networks. Whether implementing zero-trust architectures, securing API endpoints, or encrypting sensitive data at rest and in transit, I can architect secure, scalable, and compliant security solutions that align with industry best practices.`,
...

  {
    ...
    description: `I have a deep understanding of Continuous Integration (CI) and Continuous Deployment (CD), implementing automated workflows to streamline software delivery, testing, and deployment. I can design and optimize CI/CD pipelines using AWS CodePipeline, GitHub Actions, GitLab CI/CD, Jenkins, and CircleCI, ensuring efficient build automation, artifact management, and zero-downtime deployments. My expertise includes automated testing, integrating unit, integration, and end-to-end (E2E) tests into pipelines to enforce quality control before production releases.
